...
const LoginPage = () => {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    alert("Функция входа будет реализована после подключения Supabase");
  };
              ...
              <div className="grid grid-cols-2 gap-4">
                <Button 
                  ...
                  onClick={() => {
                    ...
                    alert("Вход через Google будет реализован после подключения Supabase");
                  }}
                >
                ...
                <Button 
                  ...
                  onClick={() => {
                    ...
                    alert("Вход через Facebook будет реализован после подключения Supabase");
                  }}
                >
